...
public class ValidationString {
	...
	// necesarias
	 ...
	 public static void validLength(String valor) throws StringNotValidException, NotAllowedWordsException {
		...
		// Paso 1.1. Validar si la cadena no es nula y no esta vac�a
	 	...
	 	if (valor == null || valor.isEmpty()) {
	 		throw new StringNotValidException(CodeErrors.NO_STRING, "La cadena no puede ser nula ni vacía");
     }
