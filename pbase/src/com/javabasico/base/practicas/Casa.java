...
public class Casa { //clase por defecto
	...
	private int numHabitaciones; //private porque están los atributos(datos), tipo entero (int) y se inicializa en 0
	private int planta; //private porque están los atributos(datos), tipo entero (int) y se inicializa en 0
	
	//Paso2:  Declaramos una cadena de acceso publica llamada dirección.
	public String direccion; //método público, tipo cadena (String)
	...
	public void modificar(Casa casa) {    //sobrecarga
