...
public class Casa {
	...
	private Casa() {
		System.out.println("constructor por defecto y privado");
	}
	...
	public Casa(int numHabitaciones, int plantaPorDefecto, float m2) {
		this.numHabitaciones = numHabitaciones;
		this.planta = planta;
		this.m2 = m2;
	}
	...
	public String toString() {
		return " La casa cuenta con= " + numHabitaciones + " habitaciones= , tiene= " + planta + " plantas, esta ubicada en= " + direccion + " y mide=" + m2; 
	}
